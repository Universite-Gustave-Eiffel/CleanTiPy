...
generated signal simulated using the Simulations library.
--Moving source--
...
from Simulations import MovingSrcSimu_t
import numpy as np
import pylab as pl
...
pl.figure(num='Propagated Signal - Spectrogram')
pl.specgram(Sig[0,:],2048,fs,noverlap=1024)

# Check Dopplerization
pl.figure(num='Propagated Signal')
pl.plot(Sig[0,:])
